...
function PokeReact  () {
  ...
  return (
     ...
     <div className="sbox1">
      <input className="tbox" data-testid="input-1"type="" placeholder="Pokemon" value={pokemonName1} onChange={(e)=>{setPokemonName1(e.target.value);  handleClick(); } }/>
      {
          pokemonList && (
            <>
              <select  data-testid="drop-1" className="tbox2" 
        ...
        <div className="sbox2">
      <input className="tbox" data-testid={"input-2"} type="" placeholder="Pokemon" value={pokemonName2} onChange={(e)=>{setPokemonName2(e.target.value); selected();}}/>
      {
          pokemonList && (
            <>
              <select data-testid="drop-2" className="tbox2" 
